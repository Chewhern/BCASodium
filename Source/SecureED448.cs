    ...
    public static class SecureED448
    {
        ...
        public static Byte[] GeneratePublicKey(Byte[] ED448SK, Boolean ClearKey = false)
        {
            ...
            if (ClearKey == true)
            {
                ...
                MyGeneralGCHandle = GCHandle.Alloc(ED448SK, GCHandleType.Pinned);
                SodiumSecureMemory.MemZero(MyGeneralGCHandle.AddrOfPinnedObject(), ED448SK.Length);
        ...
        public static KeyPair GenerateKeyPair()
        {
            ...
            MyGeneralGCHandle = GCHandle.Alloc(ED448PK, GCHandleType.Pinned);
            SodiumSecureMemory.MemZero(MyGeneralGCHandle.AddrOfPinnedObject(), ED448PK.Length);
            MyGeneralGCHandle.Free();
        ...
        public static Boolean Verify(Byte[] PublicKey, Byte[] Message, Byte[] Signature, Byte[] Context,Boolean ClearKey=false)
        {
