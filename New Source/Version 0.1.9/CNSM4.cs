...
namespace BCASodium
{
    public static class CNSM4
    {
        ...
        public static Byte[] HMACCTRModeEncrypt(Byte[] Message, Byte[] Nonce, Byte[] Key, Byte[] HMACKey, Boolean ClearKey = false)
        {
            if (Message == null)
            {
                throw new ArgumentException("Error: Message can't be null");
            ...
            Byte[] MAC = HMACHelper.ComputeHMAC(new SM3Digest(),CipherText,HMACKey);
        ...
        public static Byte[] HMACCTRModeDecrypt(Byte[] CipherTextWithMAC, Byte[] Nonce, Byte[] Key, Byte[] HMACKey ,Boolean ClearKey = false)
        {
            ...
            Boolean AbleToVerifyMAC = HMACHelper.VerifyHMAC(new SM3Digest(), CipherText, CipherTextMAC, HMACKey);
